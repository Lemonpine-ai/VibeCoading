...
- "Author identity unknown" 오류 시:
  git config --global user.name "Lemonpine-ai"
  git config --global user.email "bloodycroix@gmail.com"
...
```powershell
git remote add origin https://Lemonpine-ai:YOUR_GITHUB_TOKEN@github.com/Lemonpine-ai/VibeCoading.git
```
